    ...
    mutations.forEach(function (mutation) {
      mutation.addedNodes.forEach(function (node) {
        ...
        if (node.querySelectorAll) {
          const children = node.querySelectorAll(OBSERVE_SELECTOR);
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "וייב משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '057bd5ec-6517-4bbd-877f-aa2b10ae4636',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '057bd5ec-6517-4bbd-877f-aa2b10ae4636';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '057bd5ec-6517-4bbd-877f-aa2b10ae4636';
